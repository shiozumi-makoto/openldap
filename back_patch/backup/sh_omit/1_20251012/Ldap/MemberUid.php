...
*/
   ...
   /**
    ...
    public static function printMemberGroup(array $memberGroup): void
    {
        ...
        $B  = $useColor ? [\Tools\Ldap\CliColor::class,'bold']    : fn($s)=>$s;
        $G  = $useColor ? [\Tools\Ldap\CliColor::class,'green']   : fn($s)=>$s;
        $Y  = $useColor ? [\Tools\Ldap\CliColor::class,'yellow']  : fn($s)=>$s;
        $R  = $useColor ? [\Tools\Ldap\CliColor::class,'red']     : fn($s)=>$s;
        $C2 = $useColor ? [\Tools\Ldap\CliColor::class,'cyan']    : fn($s)=>$s;
