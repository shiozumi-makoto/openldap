...
// ★初期化 ou=Groups,dc=e-smile,dc=ne,dc=jp' から読みこむ
/*
...
//  $doGroup -> $gid
//	$gid = CliUtil::gidByGroup($doGroup);
//	echo "group = {$doGroup} >>> gid = {$gid} \n";
//	exit;
...
//	self::$sharedGroupMap に設定
//	CliUtil::initFromLdap($ds, $groups);
//	$info = $cli->gidByGroupLdap($doGroup); 
//	print_r($info);
*/
...
echo " flag      => {$flag} \n";
echo " usersGroupDn => ${usersGroupDn} \n";
echo " ----------------------------------------------------------- \n";
