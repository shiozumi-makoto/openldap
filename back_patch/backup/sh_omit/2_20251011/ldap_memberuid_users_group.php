...
{$B('SYNOPSIS')}
    php ldap_memberuid_users_group.php [--init] [--confirm] [--help|-h|?|/?]
...
require '/usr/local/etc/openldap/tools/autoload.php';

use Tools\Ldap\Env;
use Tools\Ldap\Connection;
use Tools\Ldap\MemberUid;
use Tools\Ldap\CliColor;


$confirm = in_array('--confirm', $argv, true);
$doInit  = in_array('--init', $argv, true) || getenv('INIT_MEMBERUIDS') === '1';
...
$usersGroupDn = Env::get('USERS_GROUP_DN', null, "cn=users,{$groups}");
